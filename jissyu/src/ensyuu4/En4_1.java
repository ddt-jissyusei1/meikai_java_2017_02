...
public class En4_1 {
	...
	public static void main(String[] args) {
		...
		do{
			...
			//入力された1または0を、繰り返し判定用の変数retryに代入する
			retry = inputStream.nextInt();

		//ユーザーが符号判定プログラムを繰り返すため、１と入力されたときのプログラム繰り返しの制御式
		}while(retry == 1);

		//retryの値が1という制御式がfalseとなった（プログラムを繰り返さない）場合、do文ブロックを抜け、プログラム終了の文を出力するためのコード
